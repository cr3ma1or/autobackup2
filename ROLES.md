● <analysis>
  ...
  - docs/README.md отсутствует. Есть корневой README.md, поэтому
    ссылка на docs/README.md либо ожидаемая структура документации
    неполна.
  ...
  - docs/failover.md содержит названия провайдеров VDSina и Aeza.
  - recensia.md:7-9 также связывает роли с VDSina и Aeza.
  ...
  документированный UID `999`, provider-tail VDSina/Aeza и
